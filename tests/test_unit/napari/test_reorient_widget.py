...
def test_reorient_stack(reorient_widget, stack):
    ...
    viewer.layers.selection.add(viewer.layers["stack_to_reorient"])

    # Starting orientation = SAL
    reorient_widget.source_origin1.setCurrentText("s")
    reorient_widget.source_origin2.setCurrentText("a")
    reorient_widget.source_origin3.setCurrentText("l")

    # End orientation = ASR
    reorient_widget.target_origin1.setCurrentText("a")
    reorient_widget.target_origin2.setCurrentText("s")
    reorient_widget.target_origin3.setCurrentText("r")
